...
<%--<form id="addBannerForm" method="post" enctype="multipart/form-data">
    图片标题:<input id="addBannerFormTitle" name="title"/><br/></br>
    描述信息:<input id="addBannerFormDescription" name="description"/><br/></br>
    选择图片:<input id="addBannerFormPicture" name="File"/></br>
...
<form id="FileuploadForm" method="POST" action="/upload" enctype="multipart/form-data">
    ...
    图片标题:<input type="text" name="title"/><br/></br>
    描述信息:<input type="text" name="description"/><br/></br>
    ...
    function upload(){
        ...
        if(null==checkFile || ""==checkFile){
            ...
            $.ajax({
                ...
                url: '${pageContext.request.contextPath}/banner/regist',
                data: formData,
                cache:false,
                processData:false,
                contentType:false,
