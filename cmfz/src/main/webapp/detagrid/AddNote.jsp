...
<div align="center" style="background:#9C9C9C; color:#0A0A0A">
<h3>添加公告</h3>


<form  id="FileuploadForm" method="POST"  action="/upload" enctype="multipart/form-data">
    公告图片:<input type="file" name="uploadFile" id="uploadFile" align="left"/><br/>
    公告标题:<input type="text" name="title" align="left"/><br/>
    公告信息:</br><textarea   name="content" style="width:400px;height:250px;"></textarea><br/>
    </br>
    ...
    function upload(){
        ...
        if(null==checkFile || ""==checkFile){
            ...
            $.ajax({
                ...
                url: '${pageContext.request.contextPath}/note/regist',
                data: formData,
                cache:false,
                processData:false,
                contentType:false,
